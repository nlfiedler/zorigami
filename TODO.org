...
*** DONE generate GraphQL schema definition file
*** DONE preliminary setup [11/11]
- [X] set up Vite to build the client
- [X] set up SolidJS/TS client in =client= directory
- [X] create =prettier.config.ts=
- [X] create =index.html=
- [X] create =tsconfig.json=
- [X] create basic =package.json=
- [X] create =vite.config.ts=
- [X] create =eslint.config.js=
- [X] revert changes to Cargo.toml for leptos
- [X] remove all of the Leptos related crates
- [X] change =main.rs= to serve =dist/index.html=
*** DONE basic page setup [7/7]
- [X] routes
- [X] navbar
- [X] styling
- [X] font awesome
- [X] color theme
- [X] graphql client
- [X] show configuration via GraphQL query
*** DONE pack stores page [21/21]
- [X] GraphQL mutation to invoke =NewStore= usecase
- [X] GraphQL mutation to invoke =UpdateStore= usecase
- [X] add =PackRetention= to GraphQL
- [X] dropdown to create new pack store
- [X] show list of pack stores on left, selected store on right
- [X] route =/stores= should work and not show 404
- [X] clicking pack store on left shows details on right
- [X] GraphQL mutation to test a pack store
- [X] GraphQL mutation to delete a pack store
- [X] need to refresh the list when ~New Store~ is invoked
- [X] need to refresh the page when ~Delete~ is invoked
- [X] test error message should show with a delete button
- [X] show help text when there are no pack stores
- [X] form for local pack store
- [X] pack retention form elements
- [X] form for SFTP pack store
- [X] form for MinIO pack store
- [X] form for Azure pack store
- [X] form for Amazon pack store
- [X] form for Google pack store
- [X] show/hide toggle is not working
*** TODO data sets page [1/4]
- [ ] add =SnapshotRetention= to GraphQL
- [X] route =/datasets= should not show a 404
- [ ] GraphQL mutation to create a blank data set
- [ ] GraphQL mutation to update a data set
*** TODO home page [0/15]
- [ ] name it ~Home~ and show summary of datasets
...
*** TODO snapshots page [0/6]
- [ ] consider showing list of snapshots with pagination
...
** TODO [#B] Change default chunk size to 1,048,576
...
*** hide the minio secret key using a show/hide button
