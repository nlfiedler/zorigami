...
**** DONE Update =README.md= wrt to Rust and requirements
**** DONE Add =gpgme= library dependency to =README.md=
***** =brew install gpgme=
**** DONE Update =NOTES.md= for several things
***** Rust vs TypeScript/JavaScript
***** RocksDB vs PouchDB
**** DONE Remove everything related to the old stack
***** DONE TODO.org
***** DONE README.md
***** DONE .gitignore
***** DONE PouchDB
