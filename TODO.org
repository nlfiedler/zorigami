* Zorigami
** kohaku remote (minio) backup
*** DONE form for defining an SFTP store
**** DONE new store form needs to have a "kind" selector
**** DONE selecting different kind will rebuild new store form accordingly
**** DONE make a different form and validation module for each type of store
*** DONE allow multiple stores per dataset
**** really should run one backup, store local and sftp at the same time
*** DONE need to add default port of 22 for sftp, if no port is given
*** DONE change minio store to have access key and secret key
*** TODO something else is wrong now, backup remains in progress indefinitely
#+BEGIN_SRC
[2019-11-08T01:45:20Z INFO  zorigami::supervisor] dataset 01ds22tpes59nynfpvgrd1zq1c to be backed up
[2019-11-08T01:45:20Z DEBUG zorigami::engine] performing backup for dataset-01ds22tpes59nynfpvgrd1zq1c
[2019-11-08T01:50:20Z DEBUG zorigami::supervisor] dataset 01ds22tpes59nynfpvgrd1zq1c backup already in progress
...
[2019-11-08T03:05:20Z DEBUG zorigami::supervisor] dataset 01ds22tpes59nynfpvgrd1zq1c backup already in progress
[2019-11-08T03:10:05Z INFO  zorigami::supervisor] no new snapshot required
[2019-11-08T03:10:20Z DEBUG zorigami::supervisor] dataset 01ds22tpes59nynfpvgrd1zq1c backup already in progress
...
[2019-11-08T04:40:20Z DEBUG zorigami::supervisor] dataset 01ds22tpes59nynfpvgrd1zq1c backup already in progress
#+END_SRC
...
**** have to decide how much this really matters in practice
**** there will always be a race condition of computing the digest and packing the file
*** TODO detect file deletion during backup, mark file record as skipped
**** handle the error and mark the record as "failed"
