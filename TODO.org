...
** TODO Rebuild and deploy on ~tampopo~ from scratch
*** TODO stop =zorigami= process
*** TODO delete =~/Library/Application\ Support/Zorigami/dbase*=
*** TODO delete all S3 buckets on ~production~ account
*** TODO build and deploy locally
*** TODO configure packs and dataset
*** TODO verify successful backup
** TODO Run =replica.sh= from ~chihiro~ to ~kohaku~ again
** TODO Rebuild and deploy to ~chihiro~ from scratch
*** TODO stop =zorigami_app_1= container
*** TODO destroy =safe/packs= zfs dataset
*** TODO delete =/zeniba/zorigami/database/dbase*=
*** TODO create a new ~Google Cloud~ project
*** TODO build and deploy =zorigami=
*** TODO configure packs and dataset
*** TODO verify successful backup
** Database Integrity
