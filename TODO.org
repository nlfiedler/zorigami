* Tasks
** Dioxus
*** TODO find out how to test the app; still unclear
*** TODO initial setup [0/4]
- [ ] add the crates
- [ ] get it to build (ssr feature gating)
- [ ] add Bulma CSS
- [ ] show something on the screen
*** TODO prototype
**** home page [0/3]
- [ ] show computer identifier
- [ ] light/dark color theme
- [ ] navigation bar with empty pages
**** data sets page [/]
- [ ] show something
**** pack stores page [/]
- [ ] show something
**** restore operations page [/]
- [ ] show something
**** snapshots page [0/1]
- [ ] show something
*** TODO remove flutter [0/9]
...
** TODO replace =lazy_static= with =std::sync::LazyLock=
