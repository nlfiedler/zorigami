...
** Loose WebUI tasks
*** TODO should disable the ~manual~, ~weekly~, and ~monthly~ frequency options for now
...
*** TODO dataset start/stop schedule should make clear it is 24-hour UTC
**** even better, show the local time as well
