* Tasks
** Fix bucket reuse
*** =PackRepositoryImpl= is getting recreated so counts are lost
*** TODO change =name_count= to be a global instead of instance member
** Statistics
*** TODO change the file size cut points to be powers of two
**** 1/8/16/32/64/128 kb and so on
