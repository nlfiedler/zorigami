...
*** DONE Implement a store supporting SFTP
...
**** DONE Use a docker container for testing sftp properly
***** c.f. https://hub.docker.com/r/atmoz/sftp/
***** DONE Add a =docker-compose.yml= file (and host keys?)
**** DONE Define an =Options= for SFTP constructor to provide password, private key, passphase, port
**** DONE Add notes to =README= about using docker container for testing
**** DONE Allow setting username, password, private key, and key passphrase
...
*** DONE How does one document the events from emitters?
**** DONE Use "Events" "technique 3" at [[https://cancerberosgx.github.io/javascript-documentation-examples/examples/typedoc-tutorial-basic/docs/docco/src/index.html][cancerberosgx.github.io]]
*** DONE Settle on =require= vs proper =import= statements
**** c.f. https://www.typescriptlang.org/docs/handbook/modules.html
**** DONE make sure compiler module is =commonjs=
**** DONE make sure to use =export default foo= instead of =export = foo=
...
*** TODO Check out the documentation for =tsconfig.json= and compiler options
** Phase 3
