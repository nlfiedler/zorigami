...
*** TODO pack prune tries to remove OS folders, results in IO error
#+begin_src
[server::domain::usecases::prune_extra] PruneExtra expecting 336 packs in store 01fea6tb4jxqar59s02va72p4t
[server::data::repositories] prune_extra scanning bucket 01fecd410dtgfyq5aj6khvxqfz769d0a5d984c5eb98906c73ae3132ff8
[server::data::repositories] prune_extra scanning bucket 01fec72w725a7399f7n9x08ssc769d0a5d984c5eb98906c73ae3132ff8
[server::data::repositories] prune_extra scanning bucket 769d0a5d984c5eb98906c73ae3132ff8
[server::data::repositories] prune_extra scanning bucket .fseventsd
[server::data::repositories] remove_bucket: deleting object fseventsd-uuid
[server::data::repositories] remove_bucket: deleting bucket .fseventsd
[server::data::repositories] prune_extra scanning bucket .Spotlight-V100
#+end_src
** Dataset start/stop time options
*** Using UTC for the start/stop time is hard to visualize
*** Maybe show the local time along with the UTC time as a guide
*** Maybe have a timezone selector
*** Maybe always assume local time
**** Trouble will be knowing when to switch from ~standard~ to ~daylight~ time
