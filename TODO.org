...
**** show a dialog or something to indicate ongoing progress (spinner)
**** progress dialog has a cancel button to stop the restore
**** when the request is ready, replace cancel button with download button
**** consider what happens if user navigates away from this page
*** desktop
