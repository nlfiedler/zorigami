...
**** TODO move =PackBuilder= into =domain/helpers/packs.rs=
**** TODO move =find_file_chunks()= into =domain/helpers/chunks.rs=
**** TODO move =encrypt_file()= into =domain/helpers/crypto.rs=
**** TODO move =decrypt_file()= into =domain/helpers/crypto.rs=
