...
*** TODO Settle on =require= vs proper =import= statements
**** c.f. https://www.typescriptlang.org/docs/handbook/modules.html
**** TODO make sure compiler target is =commonjs=
**** TODO make sure to use =export default foo= instead of =export = foo=
