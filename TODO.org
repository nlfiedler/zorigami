...
*** DONE delete temp database and refine initial setup experience [9/9]
- [X] home page: if no stores, guide toward defining a pack store, mention database restore, link to restore page
- [X] home page: if no data sets, guide toward defining a data set
- [X] store page: when there are no stores, provide instruction
- [X] dataset page: when there are no stores, provide instruction
- [X] dataset page: when there are no datasets, provide instruction
- [X] snapshots page: when there are no stores, link to stores page
- [X] snapshots page: when there are no datasets, link to datasets page
- [X] snapshots page: when there are no snapshots, indicate that something will happen eventually
- [X] restore page: when there are no stores, suggest going to stores page to define some stores
*** TODO home page [0/9]
