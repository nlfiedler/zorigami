...
***** TODO translate =processPath()=
***** TODO translate =scantree()=
...
***** TODO insert xattr records for each tree entry (see =process_path()=)
...
**** TODO Chunk serde should skip digest and database must set digest using key (minus prefix)
