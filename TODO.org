* Tasks
** Cleanup and Testing
*** TODO change restore ~manager~ design for thorough testing
**** TODO make =FileRestorer= into a trait and implementation
**** TODO add tests for the restorer implementation itself
**** TODO use mock =FileRestorer= to test =RestorerImpl= and =RestoreSupervisor=
