...
*** TODO Show number of files in a directory in the tree browser
*** TODO Replace =provider= usage with =riverpod=, a better Provider
...
*** TODO next backup initially shows stats from previous backup
*** TODO for a backup with nothing new, emits progress 3 times
#+BEGIN_SRC
[INFO  server::domain::managers::process] dataset 01et6rw56bvndgwb7n3q19rqp6 to be backed up
[INFO  server] progress for 01et6rw56bvndgwb7n3q19rqp6: packs: 0, files: 0
[INFO  server] progress for 01et6rw56bvndgwb7n3q19rqp6: packs: 0, files: 0
[INFO  server] complete for 01et6rw56bvndgwb7n3q19rqp6: packs: 0, files: 0
[INFO  server::domain::managers::process] no new snapshot required
#+END_SRC
*** TODO look at updating =mockall= dependency
