...
**** TODO Need to inject digest when deserializing objects from database
***** TODO pack objects
***** TODO file objects
***** TODO add tests for that
**** TODO Decide how to store "service provider" configuration
***** maybe the store implementations get a database handle and read/write their own config
...
***** TODO implement the "dataset" type, write unit tests
***** TODO implement =perform_backup()=
***** TODO open database instance and pass =DB= around
***** TODO implement =restore_file()=
***** DONE insert xattr records for each tree entry (see =process_path()=)
**** TODO Use =tmp/test= instead of =test/tmp= in test code
