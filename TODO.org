...
*** TODO add a graphql query to list the contents of a specific pack file
**** write a use case and entity to return pack details
**** fetch pack file, decrypt, use =tar= crate to get detailed listing
**** query contents of =ef6ff7a6d8c7b1ab2324663ba4280700674ed587a9ff05dcaacdae1e52f21fe0=
