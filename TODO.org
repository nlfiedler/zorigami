* Tasks
** TODO [#A] update Rust dependencies
** TODO [#A] update Rust edition to 2024
** TODO [#A] update =healthcheck= code using =namazu= as a reference
** TODO [#A] Replace minio container with something else
*** MinIO is in maintenance mode, admin ui removed (and licensing problems)
*** https://github.com/opens3/console
*** https://ceph.io/en/ offers S3 compatible interface
*** https://hub.docker.com/r/rustfs/rustfs (S3 compatible)
*** https://garagehq.deuxfleurs.fr
** TODO [#A] Use =HashedArrayTree= instead of =Vec= in ~get_all~ functions in =EntityDataSourceImpl=
*** functions in =EntityDataSourceImpl= to be changed [0/4]
- [ ] get_all_tree_digests()
- [ ] get_all_file_digests()
- [ ] get_all_chunk_digests()
- [ ] get_all_xattr_digests()
** TODO [#A] Move domain/managers, helpers into =tasks=, at same level as =data=, =domain=, =preso=
*** these long-running ~workers~ get stuff done asynchronously, not because of use cases
*** document this in =doc/DESIGN.md=
*** save this link: https://gist.github.com/quad/bc2351e2df4a4a815f8e0d19f36cfa80
** TODO [#B] Switch from =juniper= to =async-graphql=
*** https://crates.io/crates/async-graphql
*** TODO can =async-graphql= generate a schema thing for clients to use?
*** TODO can Apollo GraphQL generate a schema thing for TypeScript to use from the =/graphql= endpoint alone?
*** TODO structure the code into smaller files
** TODO [#B] Replace Flutter/Leptos with SolidJS/TypeScript
*** TODO preliminary setup [0/9]
- [ ] set up Vite to build the client
- [ ] set up SolidJS/TS client in =client= directory
- [ ] create =tsconfig.json=
- [ ] create basic =package.json=
- [ ] create =vite.config.ts=
- [ ] create =eslint.config.js=
- [ ] revert changes to Cargo.toml for leptos
- [ ] remove all of the Leptos related crates
- [ ] change =main.rs= to serve the compiled JS
...
*** TODO maybe replace the navbar icon with a fontawesome icon
