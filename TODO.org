* Tasks
** Flutter updates
*** Set flutter SDK version in docker build for consistent results
**** c.f. https://github.com/flutter/flutter/issues/64238
**** use https://pub.dev/packages/fvm
**** =fvm install 1.26.0-1.0.pre=
**** update instructions in =README.md=
*** flutter form build has major updates
*** look at all of the other dependencies
** Pack store bucket efficiency
*** creating too many buckets, after 6 months over 700 buckets on google
**** there are only 238 buckets in the safe and minio
*** should use one bucket until it has at least N objects in it
*** keep the current bucket name in the dataset configuration?
...
*** Test Case: Google
**** bucket =01ee37jcp2jg2p86qq39aqj9q8afd73b8b997a5452b94a6b7c564041b1= should be pruned
**** there are 500 additional buckets on google that should not be there
*** Test Case: minio
