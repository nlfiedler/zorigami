...
**** TODO failed to stop at the right time
***** was changing the schedule and letting the backup restart
***** log contents
#+BEGIN_SRC
DEBUG server::domain::managers::process] dataset 01edn29q3m3n7ccpd2sfh4244b backup had an error, will restart
DEBUG server::domain::managers::process] runner received backup message
DEBUG server::domain::managers::process] runner spawned backup process
INFO  server::domain::managers::process] dataset 01edn29q3m3n7ccpd2sfh4244b to be backed up
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 0, files: 0
DEBUG server::domain::managers::backup] performing backup for dataset-01edn29q3m3n7ccpd2sfh4244b
DEBUG server::domain::managers::backup] continuing previous backup sha1-b4e84b17854e3af3689aa9bcaf8b36d81c029e67
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 1, files: 0
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 1, files: 5
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 2, files: 5
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 2, files: 13
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 3, files: 13
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 3, files: 18
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 4, files: 18
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 4, files: 28
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 5, files: 28
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 5, files: 47
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 6, files: 47
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 6, files: 62
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 7, files: 62
INFO  server] progress for 01edn29q3m3n7ccpd2sfh4244b: packs: 7, files: 62
#+END_SRC
***** DONE add tests for the backup stopping early
*** TODO use gcloud tools to verify that same pack files exist everywhere
**** buckets and objects in safe, yubaba, and google should all match
*** TODO eventually remove the old ~akashita~ project and files
*** TODO when backup finishes, remove some files
...
***** waiting for a license to be chosen by the author
