...
*** TODO should compress chunks on the way into the pack file
**** pack file sizes vary widely due to compression happening late
**** should compress the chunks as they go into the pack file
**** then do not compress the final pack file
