* Tasks
** TODO [#A] Replace Flutter/Leptos with SolidJS/TypeScript
*** DONE generate GraphQL schema definition file
*** TODO preliminary setup [2/11]
...
** TODO [#B] Pack file and database backup pruning
