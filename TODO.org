...
** TODO [#A] Replace minio with SeaweedFS
*** MinIO is in maintenance mode (and licensing problems)
*** https://github.com/seaweedfs/seaweedfs
*** convert the =store_minio= to SeaweedFS as well, rename envars, update docs
