...
**** DONE need "type" field for =Store= in GraphQL schema
**** DONE =stores= query should return full =Store= for streamlined queries
**** TODO need a label field for =Store= in GraphQL schema
**** TODO Set up the reason-react routing
***** TODO decide on routes
...
**** TODO Figure out how to use reductive with JSX 3
