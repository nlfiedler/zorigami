...
*** mini before: took snapshot ... with 555706 files after 3 minutes 2 seconds
*** mini after:
*** server before: took snapshot ... with 147769 files after 1 hours 20 minutes 14 seconds
*** server after:
** Chunking
...
*** make sure =dbase= directory exists ahead of time?
*** how to update
