* Tasks
** DONE Test full restore on ~yubaba~ from snapshot ~7/31/2023~
*** using snapshot ~7/31/2023~ [18/18]
- [X] Antonia
- [X] Applications
- [X] Artwork
- [X] Books
...
- [X] tanuki
- [X] Writings
*** files whose chunks are missing from their packs
- Pictures/christina/2023-07-plusmore/DSCF0025.JPG
- Pictures/christina/2023-07-plusmore/DSCF0052.JPG
- Pictures/christina/2023-07-plusmore/DSCF0088.JPG
- Pictures/christina/2023-07-plusmore/DSCF0152.JPG
- Pictures/christina/2023-07-plusmore/DSCF0173.JPG
- Pictures/christina/2023-07-plusmore/DSCF0234.JPG
- Pictures/christina/2023-07-videos/DSCF0116.AVI
- Pictures/old_macbook/Photos Library.photoslibrary/Masters/2010/Dec 28, 2010_2/IMG_0062.JPG
- Pictures/old_macbook/Photos Library.photoslibrary/Masters/2011/Nov 14, 2011/IMG_1211.JPG
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Masters/2010/Dec 28, 2010_2/IMG_0062.JPG
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Masters/2011/Nov 14, 2011/IMG_1211.JPG
- tanuki/assets/blobstore/2015/04/14/0315/01ce1qda00xdh84x7n2exx05sd.jpg
- tanuki/assets/blobstore/2020/01/21/0430/01dz35vdfn3p5kqvkr69n3b5sz.jpg
*** files whose records are missing from the database
- tanuki/assets/blobstore/2023/05/21/2215/01h106dakr177a8c105etsr3fw.jpg
*** files that could not be restored: =No such file or directory (os error 2)=
- Antonia/Downloads/Quicken Data/Quicken Data.qdfm/Contents/Quicken State/DRAT#15967 Fixed
- Pictures/old_macbook/Photos Library.photoslibrary/Data
- Pictures/old_macbook/Photos Library.photoslibrary/Modified
- Pictures/old_macbook/Photos Library.photoslibrary/Originals
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Data
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Database/BigBlobs.apdb
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Database/Faces.db
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Database/History.apdb
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Database/ImageProxies.apdb
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Database/Library.apdb
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Database/Properties.apdb
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Modified
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Originals
** DONE Test fresh backup to new store, examine logs
*** DONE clear the database on ~yubaba~
*** DONE find a destination for the packs (need ~300gb)
*** DONE configure ~yubaba~ to backup =/zeniba/shared= to =minio= on ~kohaku~
*** DONE analyze the logs for any issues (save the log for further analysis)
** DONE Test full restore again on ~yubaba~ from ~minio~ pack store
*** using snapshot ~8/11/2023~ [18/18]
- [X] Antonia
- [X] Applications
- [X] Artwork
- [X] Books
...
- [X] tanuki
- [X] Writings
*** files missing from pack
- Pictures/old_macbook/iPhoto Library.migratedphotolibrary/Masters/2015/04/08/20150408-101641/IMG_5257.JPG
- tanuki/assets/blobstore/2017/03/01/1745/01ce1qd6v61e2aqv9ysq1500b2.jpg
- tanuki/assets/blobstore/2020/05/20/0245/01e8qzpn1m3ay9fr083pyshrgc.jpg
- tanuki/assets/blobstore/2020/12/14/0130/01esfeczsjcznn83t40zrgn47v.jpeg
- tanuki/assets/blobstore/2022/08/28/2230/01gbk9hv4gwsb7tnes2rah6hfj.jpg
- tanuki/assets/blobstore/2022/08/28/2230/01gbk9kqc5c9zb7pjsj7187dcz.jpg
- tanuki/assets/blobstore/2022/08/28/2230/01gbk9mefj9nw0mw9hvh8ys2eg.jpg
- tanuki/assets/blobstore/2022/08/28/2230/01gbk9nrgwrrqr7v18ryxdtyj5.jpg
** DONE Reproduce pack build failure on ~yubaba~; did not fail
*** minio coordinates
| endpoint                | access key           | secret key                               |
|-------------------------+----------------------+------------------------------------------|
| http://192.168.1.2:9000 | 5vdLrP2iZUAxZzhvNcYe | RfZ1AoKj5nWdSROC5z4rzDPJRP7YfbCkUnJBqa8A |
*** DONE clear minio packs
*** DONE deploy zorigami
*** DONE start a full backup
** TODO Test full backup and restore on ~yubaba~ using ~minio~
*** create the dataset, set to ~hourly~, once it starts, set to ~manual~
*** using the one snapshot [0/18]
- [ ] Antonia
- [ ] Applications
- [ ] Artwork
- [ ] Books
...
- [ ] tanuki
- [ ] Writings
** TODO write unit tests for =PackRecord=
** TODO convert =take_snapshot()= to a use case with unit tests
**** tests in =backup_manager_test.rs= will move to this new use case
** TODO try to find the packs that contain the missing files
*** TODO write a query that searches all pack files to find a chunk by its digest
*** TODO find which files have chunks that are missing from their packs
*** missing file records
- e390da5ca7b3bcb53de5201915b2c617a2cef419c8660772f835651bb452fb0f
*** missing chunks from packs
- tanuki/assets/blobstore/2015/04/14/0315/01ce1qda00xdh84x7n2exx05sd.jpg
- tanuki/assets/blobstore/2020/01/21/0430/01dz35vdfn3p5kqvkr69n3b5sz.jpg
** Database Integrity
...
**** TODO run the test on ~chihiro~ instance, should find at least one missing file record
*** support repairing the broken database
**** missing file records mean an entire snapshot is invalid
***** fix by changing the next snapshots ~parent~ to be the parent of the invalid snapshot
***** if the invalid snapshot is the most recent snapshot, change the latest snapshot record
**** files missing from a pack file means an entire snapshot is invalid
*** add option to delete all snapshots and start again
...
- dbase/
- tree/
**** delete all stored pack files from all stores?
** Improve backup reliability
*** document the details of the scan and backup process
**** what database records are created when?
**** what ensures that the database records are reliable?
**** if a snapshot is marked as complete, what does that guarantee?
*** consider how to collect and record information to ensure reliability
**** if existing file record is present, ensure the chunk/pack records also exist
...
*** setting start/stop time for dataset has broken (time input cannot be dismissed)
...
*** snapshot time range shows stop time of the most recent snapshot on all snapshots
*** web ui should refresh restore requests page every few seconds
*** fix all the stateful widgets to use the new convention
**** replace the specific return type of =createState()= with the generic version
#+begin_src dart
...
#+end_src
*** snapshots display should not have > button when there are no snapshots
...
***** have =Restorer= create this type and pass a =Arc<Mutext>= to supervisor
...
*** Buttons to start and stop a backup; currently ~Manual~ frequency means no backups at all
...
**** excludes: =.Trash, Library, **/Downloads, **/node_modules, **/target, fvm=
**** run hourly
** primary
