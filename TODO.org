...
*** TODO update leptos (0.8) and related crates (leptos-use)
*** TODO secret fields should be hidden with option to show them
*** TODO add button to test the pack store connection
*** TODO add some label or something that shows the type of pack store
**** not entirely obvious what you're looking at with just the form labels
*** TODO datasets page
*** TODO snapshots page
...
*** TODO browse page
**** maybe name it ~Home~ and show summary of datasets, packs, latest snapshot
...
** [#B] Snapshot retention policy default
...
** [#C] Pack file and database backup pruning
