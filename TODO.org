...
***** TODO allow browsing the snapshot tree
...
****** need a "plus" button somewhere (FAB in nav rail)
...
***** TODO consider using =BlocDelegate= to catch errors in all blocs
****** gives a chance to log errors
...
*** TODO improvements to the interface
