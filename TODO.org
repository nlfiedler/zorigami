...
***** DONE add =insert_file()= to repo
***** DONE add =get_file()= to repo
***** DONE add =insert_tree()= to repo
***** DONE add =get_tree()= to repo
***** DONE add =insert_xattr()= to repo
***** DONE add =get_xattr()= to repo
***** DONE add =insert_pack()= to repo
***** DONE add =get_pack()= to repo
***** DONE add =put_snapshot()= to repo
***** TODO expose the database path for default exclusions
***** TODO expose the backup/restore database functions via repo
***** management code (state, backup, restore, process)
***** backup manager: skip datasets that have no stores
