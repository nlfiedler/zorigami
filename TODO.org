* Tasks
** TODO SolidJS
*** TODO update =Dockerfile= based on tanuki
*** TODO update =DEPLOY.txt= regarding macOS installation
...
** TODO [#A] Automatic snapshot pruning a la Time Machine
...
** TODO [#B] Scheduler to test restoring a random file weekly
...
** TODO [#B] Scheduler to perform a ~scrub~ of the database weekly
...
**** should be able to implement this in the client only
