* Tasks
** Fix minio store impl such that =block_on= does not fail ever
** Replace unmaintained Google API crate
*** https://github.com/Byron/google-apis-rs (google-storage1 source)
*** https://github.com/dermesser/async-google-apis outdated
*** https://crates.io/crates/cloud-storage inflexible envar/file-based auth
*** https://github.com/google-apis-rs/google-cloud-rs order of magnitude less popular than google-storage1
...
*** TODO Create a local deployment script to automate desktop updates
