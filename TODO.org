...
*** TODO browse page
**** maybe name it ~Home~ and show summary of datasets
**** for each dataset, show date/time of latest snapshot
**** for each dataset, show how many snapshots exist
**** for each dataset, show retention policy, provide button to prune according to policy
...
** TODO rename all of the =mod.rs= files
*** can now have =foobar.rs= and =foobar/other.rs= without the =foobar/mod.rs=
** Leptos improvements
*** pack stores page
...
** [#B] Pack file and database backup pruning
